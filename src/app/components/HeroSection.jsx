...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Estructura en dos partes: imagen izquierda, texto derecha */}
      <div className="w-full flex">
        ...
        <div className="w-1/2 flex items-center px-10">
          <motion.div 
            className="w-full pt-0 pb-16" /* Añadido padding negativo arriba */
          ...
          >
            ...
            >
              <div>Soy</div>
              <div className="pl-16 md:pl-24"><span className="text-white">Jeronimo</span></div>
